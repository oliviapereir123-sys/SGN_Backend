...
private $host     = "sql305.infinityfree.com"; // host do cPanel
private $db_name  = "epiz_XXXXXXX_sgn_ipm";    // nome com prefixo
private $username = "epiz_XXXXXXX_user";        // utilizador com prefixo
private $password = "a_tua_password";
