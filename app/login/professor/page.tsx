...
export default function ProfessorLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await login("professor", { email, password })
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-secondary to-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl font-bold mb-4">Portal do Professor</h1>
            <p className="text-white/80 text-lg mb-8 max-w-md">
              Gerencie suas turmas, lance notas e acompanhe o desempenho dos alunos de forma simples e eficiente.
            </p>

            <div className="space-y-4">
              {[
                { icon: ClipboardList, text: "Lance notas e avaliações" },
                { icon: Users, text: "Gerencie suas turmas" },
                { icon: BarChart3, text: "Acompanhe estatísticas de desempenho" },
              ].map((item, index) => (
                <motion.div
                  key={item.text}
        ...
        >
          ...
          <div className="bg-card rounded-2xl shadow-xl border border-border p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-foreground">Área do Professor</h1>
              <p className="text-muted-foreground mt-2">Acesse o sistema de gestão académica</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-muted-foreground">Manter sessão</span>
                </label>
              ...
              <Button type="submit" className="w-full h-12 bg-secondary hover:bg-secondary/90" disabled={isLoading}>
                {isLoading ? (
                  <>
