...
export default function AlunoHorariosPage() {
        ...
        <main className="p-6">
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-2xl font-bold">Horário da Turma</h1>
            ...
            <Card>
              ...
              <CardContent>
                {loading ? (
                  ...
                  <p className="text-muted-foreground text-center py-8">Nenhum horário definido para a sua turma.</p>
                ) : (
