    ...
    getAdminStats()
      .then((res: any) => {
        if (res?.success) {
          ...
          setErro("O servidor não devolveu dados válidos.")
        }
      })
      .catch((err: any) => {
        setErro(err?.message || "Erro ao carregar estatísticas.")
      })
